...
class EncuestaTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('FECHA_ELABORACION', 'FechaElaboracion', 'TIMESTAMP', false, null, 'now()');
		// validators
	} // initialize()
	...
	{
    $this->addRelation('Item', 'Item', RelationMap::ONE_TO_MANY, array('id' => 'id_encuesta', ), null, 'CASCADE');
	} // buildRelations()
