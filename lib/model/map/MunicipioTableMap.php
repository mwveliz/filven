...
class MunicipioTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->setPrimaryKeyMethodInfo('municipio_id_seq');
		// columns
		$this->addPrimaryKey('ID', 'Id', 'INTEGER', true, null, null);
		$this->addColumn('MUNICIPIO', 'Municipio', 'VARCHAR', false, 255, null);
    ...
    $this->addRelation('Parroquia', 'Parroquia', RelationMap::ONE_TO_MANY, array('id' => 'id_municipio', ), null, 'CASCADE');
	} // buildRelations()
