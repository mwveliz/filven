...
/**
 * Base class that represents a row from the 'sala' table.
 *
 * 
 *
 ...
 */
abstract class BaseSala extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the nombre_sala field.
	 * @var        string
	 */
	protected $nombre_sala;

	/**
	 * The value for the descripcion_sala field.
	 * @var        string
	 */
	protected $descripcion_sala;
	...
	/**
	 * Get the [nombre_sala] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [descripcion_sala] column value.
	 * 
	 * @return     string
	 */
	public function getDescripcionSala()
	{
		return $this->descripcion_sala;
	}
	 ...
	 * @return     Sala The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SalaPeer::ID;
		}
	...
	/**
	 * Set the value of [nombre_sala] column.
	 * 
	 * @param      string $v new value
	 * @return     Sala The current object (for fluent API support)
	 */
	public function setNombreSala($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->nombre_sala !== $v) {
			$this->nombre_sala = $v;
			$this->modifiedColumns[] = SalaPeer::NOMBRE_SALA;
		}
	...
	/**
	 * Set the value of [descripcion_sala] column.
	 * 
	 * @param      string $v new value
	 * @return     Sala The current object (for fluent API support)
	 */
	public function setDescripcionSala($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->descripcion_sala !== $v) {
			$this->descripcion_sala = $v;
			$this->modifiedColumns[] = SalaPeer::DESCRIPCION_SALA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->nombre_sala = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->descripcion_sala = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = SalaPeer::NUM_COLUMNS - SalaPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Sala object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SalaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseSala:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSala:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseSala:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSala:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				SalaPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(SalaPeer::ID) ) {
					...
					$affectedRows = SalaPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SalaPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SalaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				return $this->getNombreSala();
				break;
			case 2:
				return $this->getDescripcionSala();
				break;
			default:
				return null;
				break;
	...
	{
		$keys = SalaPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getNombreSala(),
			$keys[2] => $this->getDescripcionSala(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				$this->setNombreSala($value);
				break;
			case 2:
				$this->setDescripcionSala($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setNombreSala($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setDescripcionSala($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SalaPeer::ID)) $criteria->add(SalaPeer::ID, $this->id);
		if ($this->isColumnModified(SalaPeer::NOMBRE_SALA)) $criteria->add(SalaPeer::NOMBRE_SALA, $this->nombre_sala);
		if ($this->isColumnModified(SalaPeer::DESCRIPCION_SALA)) $criteria->add(SalaPeer::DESCRIPCION_SALA, $this->descripcion_sala);
	...
	{
		$criteria = new Criteria(SalaPeer::DATABASE_NAME);
		$criteria->add(SalaPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Sala (or compatible) type.
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @throws     PropelException
	 */
	public function copyInto($copyObj, $deepCopy = false)
	{
		$copyObj->setNombreSala($this->nombre_sala);
		$copyObj->setDescripcionSala($this->descripcion_sala);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Sala Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * If this Sala is new, it will return
	 ...
	 * Otherwise if this Sala is new, it will return
	 * an empty collection; or if this Sala has previously
	 * been saved, it will retrieve related Actividads from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Sala.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array Visitante[] List of Visitante objects
	 */
	public function getVisitantesJoinFeria($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = VisitanteQuery::create(null, $criteria);
	...
	{
		$this->id = null;
		$this->nombre_sala = null;
		$this->descripcion_sala = null;
		$this->alreadyInSave = false;
		$this->alreadyInValidation = false;
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseSala:' . $name))
		{
