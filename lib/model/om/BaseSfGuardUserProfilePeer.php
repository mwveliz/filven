...
abstract class BaseSfGuardUserProfilePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'FirstName', 'LastName', 'Birthday', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'firstName', 'lastName', 'birthday', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::FIRST_NAME, self::LAST_NAME, self::BIRTHDAY, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'FIRST_NAME', 'LAST_NAME', 'BIRTHDAY', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'first_name', 'last_name', 'birthday', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'FirstName' => 2, 'LastName' => 3, 'Birthday' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'firstName' => 2, 'lastName' => 3, 'birthday' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::FIRST_NAME => 2, self::LAST_NAME => 3, self::BIRTHDAY => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'FIRST_NAME' => 2, 'LAST_NAME' => 3, 'BIRTHDAY' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'first_name' => 2, 'last_name' => 3, 'birthday' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (SfGuardUserProfile object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = SfGuardUserProfilePeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = SfGuardUserProfilePeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + SfGuardUserProfilePeer::NUM_COLUMNS;
		} else {
			$cls = SfGuardUserProfilePeer::OM_CLASS;
			$obj = new $cls();
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(SfGuardUserProfilePeer::ID);
			if ($value) {
				$selectCriteria->add(SfGuardUserProfilePeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(SfGuardUserProfilePeer::TABLE_NAME);
			}
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(SfGuardUserProfilePeer::TABLE_NAME, $con, SfGuardUserProfilePeer::DATABASE_NAME);
