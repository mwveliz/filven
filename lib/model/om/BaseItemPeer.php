...
abstract class BaseItemPeer {
	...
	const ID_ENCUESTA = 'item.ID_ENCUESTA';

	/** the column name for the SELECCION_SIMPLE field */
	const SELECCION_SIMPLE = 'item.SELECCION_SIMPLE';

	/** the column name for the IDENTIFICADOR_ITEM field */
	const IDENTIFICADOR_ITEM = 'item.IDENTIFICADOR_ITEM';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Texto', 'IdEncuesta', 'SeleccionSimple', 'IdentificadorItem', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'texto', 'idEncuesta', 'seleccionSimple', 'identificadorItem', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TEXTO, self::ID_ENCUESTA, self::SELECCION_SIMPLE, self::IDENTIFICADOR_ITEM, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TEXTO', 'ID_ENCUESTA', 'SELECCION_SIMPLE', 'IDENTIFICADOR_ITEM', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'texto', 'id_encuesta', 'seleccion_simple', 'identificador_item', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Texto' => 1, 'IdEncuesta' => 2, 'SeleccionSimple' => 3, 'IdentificadorItem' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'texto' => 1, 'idEncuesta' => 2, 'seleccionSimple' => 3, 'identificadorItem' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TEXTO => 1, self::ID_ENCUESTA => 2, self::SELECCION_SIMPLE => 3, self::IDENTIFICADOR_ITEM => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TEXTO' => 1, 'ID_ENCUESTA' => 2, 'SELECCION_SIMPLE' => 3, 'IDENTIFICADOR_ITEM' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'texto' => 1, 'id_encuesta' => 2, 'seleccion_simple' => 3, 'identificador_item' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ItemPeer::TEXTO);
			$criteria->addSelectColumn(ItemPeer::ID_ENCUESTA);
			$criteria->addSelectColumn(ItemPeer::SELECCION_SIMPLE);
			$criteria->addSelectColumn(ItemPeer::IDENTIFICADOR_ITEM);
		} else {
			...
			$criteria->addSelectColumn($alias . '.IDENTIFICADOR_ITEM');
		}
	}
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = ItemPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + ItemPeer::NUM_COLUMNS;
		} else {
	...
	public static function doCountJoinEncuesta(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ItemPeer::ID_ENCUESTA, EncuestaPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Item objects pre-filled with their Encuesta objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinEncuesta(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Item) to $obj2 (Encuesta)
				$obj2->addItem($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Item) to the collection in $obj2 (Encuesta)
				$obj2->addItem($obj1);
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(ItemPeer::ID);
			if ($value) {
				$selectCriteria->add(ItemPeer::ID, $value, $comparison);
			} else {
