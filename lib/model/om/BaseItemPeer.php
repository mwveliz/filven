...
abstract class BaseItemPeer {
	...
	/** the column name for the NUMERACION field */
	const NUMERACION = 'item.NUMERACION';

	/** the column name for the TEXTO field */
	const TEXTO = 'item.TEXTO';

	/** the column name for the TIPO_ITEM field */
	const TIPO_ITEM = 'item.TIPO_ITEM';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Numeracion', 'Texto', 'TipoItem', 'Maximo', 'IdEncuesta', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'numeracion', 'texto', 'tipoItem', 'maximo', 'idEncuesta', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NUMERACION, self::TEXTO, self::TIPO_ITEM, self::MAXIMO, self::ID_ENCUESTA, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NUMERACION', 'TEXTO', 'TIPO_ITEM', 'MAXIMO', 'ID_ENCUESTA', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'numeracion', 'texto', 'tipo_item', 'maximo', 'id_encuesta', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Numeracion' => 1, 'Texto' => 2, 'TipoItem' => 3, 'Maximo' => 4, 'IdEncuesta' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'numeracion' => 1, 'texto' => 2, 'tipoItem' => 3, 'maximo' => 4, 'idEncuesta' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NUMERACION => 1, self::TEXTO => 2, self::TIPO_ITEM => 3, self::MAXIMO => 4, self::ID_ENCUESTA => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NUMERACION' => 1, 'TEXTO' => 2, 'TIPO_ITEM' => 3, 'MAXIMO' => 4, 'ID_ENCUESTA' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'numeracion' => 1, 'texto' => 2, 'tipo_item' => 3, 'maximo' => 4, 'id_encuesta' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ItemPeer::NUMERACION);
			$criteria->addSelectColumn(ItemPeer::TEXTO);
			$criteria->addSelectColumn(ItemPeer::TIPO_ITEM);
			$criteria->addSelectColumn(ItemPeer::MAXIMO);
			$criteria->addSelectColumn(ItemPeer::ID_ENCUESTA);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.NUMERACION');
