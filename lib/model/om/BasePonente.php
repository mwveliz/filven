...
abstract class BasePonente extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the especialidad field.
	 * @var        string
	 */
	...
	/**
	 * Get the [especialidad] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [especialidad] column.
	 * 
	 * @param      string $v new value
	 * @return     Ponente The current object (for fluent API support)
	 */
	public function setEspecialidad($v)
	{
		...
		if ($this->especialidad !== $v) {
			$this->especialidad = $v;
			$this->modifiedColumns[] = PonentePeer::ESPECIALIDAD;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->nacionalidad = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->especialidad = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = PonentePeer::NUM_COLUMNS - PonentePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setNacionalidad($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setEspecialidad($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PonentePeer::ESPECIALIDAD)) $criteria->add(PonentePeer::ESPECIALIDAD, $this->especialidad);
	 ...
	 * @return     PropelCollection|array PonenteRelActividad[] List of PonenteRelActividad objects
	 */
	public function getPonenteRelActividadsJoinActividad($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = PonenteRelActividadQuery::create(null, $criteria);
