...
abstract class BaseEstado extends BaseObject  implements Persistent
{
	...
	/**
	 * @var        array Municipio[] Collection to store aggregation of Municipio objects.
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = EstadoPeer::NUM_COLUMNS - EstadoPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(EstadoPeer::ID) ) {
	 ...
	 * @return     void
	 */
	public function initMunicipios()
	{
	 ...
	 * @return     PropelCollection|array Municipio[] List of Municipio objects
	 * @throws     PropelException
	 */
	public function getMunicipios($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collMunicipios || null !== $criteria) {
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collMunicipios) {
				foreach ((array) $this->collMunicipios as $o) {
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseEstado:' . $name))
		{
