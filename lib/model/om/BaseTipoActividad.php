...
abstract class BaseTipoActividad extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the nombre_tipo field.
	 * @var        string
	 */
	protected $nombre_tipo;

	/**
	 * The value for the descripcion_tipo field.
	 * @var        string
	 */
	protected $descripcion_tipo;
	...
	/**
	 * Get the [nombre_tipo] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [descripcion_tipo] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [nombre_tipo] column.
	 * 
	...
	public function setNombreTipo($v)
	{
		...
		if ($this->nombre_tipo !== $v) {
			$this->nombre_tipo = $v;
			$this->modifiedColumns[] = TipoActividadPeer::NOMBRE_TIPO;
		}
	...
	/**
	 * Set the value of [descripcion_tipo] column.
	 * 
	 * @param      string $v new value
	 * @return     TipoActividad The current object (for fluent API support)
	 */
	public function setDescripcionTipo($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->descripcion_tipo !== $v) {
			$this->descripcion_tipo = $v;
			$this->modifiedColumns[] = TipoActividadPeer::DESCRIPCION_TIPO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->nombre_tipo = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->descripcion_tipo = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = TipoActividadPeer::NUM_COLUMNS - TipoActividadPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getDescripcionTipo(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setDescripcionTipo($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TipoActividadPeer::NOMBRE_TIPO)) $criteria->add(TipoActividadPeer::NOMBRE_TIPO, $this->nombre_tipo);
		if ($this->isColumnModified(TipoActividadPeer::DESCRIPCION_TIPO)) $criteria->add(TipoActividadPeer::DESCRIPCION_TIPO, $this->descripcion_tipo);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setDescripcionTipo($this->descripcion_tipo);
