...
abstract class BaseActividad extends BaseObject  implements Persistent
{
	...
	public function setIdPonente($v)
	{
		...
		if ($this->id_ponente !== $v) {
			$this->id_ponente = $v;
			$this->modifiedColumns[] = ActividadPeer::ID_PONENTE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_ponente = ($row[$startcol + 17] !== null) ? (int) $row[$startcol + 17] : null;
			$this->facilitador = ($row[$startcol + 18] !== null) ? (int) $row[$startcol + 18] : null;
			$this->id_feria = ($row[$startcol + 19] !== null) ? (int) $row[$startcol + 19] : null;
			$this->resetModified();
			...
			return $startcol + 20; // 20 = ActividadPeer::NUM_COLUMNS - ActividadPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[17] => $this->getIdPonente(),
			$keys[18] => $this->getFacilitador(),
			$keys[19] => $this->getIdFeria(),
		);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[17], $arr)) $this->setIdPonente($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setFacilitador($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setIdFeria($arr[$keys[19]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ActividadPeer::ID_PONENTE)) $criteria->add(ActividadPeer::ID_PONENTE, $this->id_ponente);
