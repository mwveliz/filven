...
abstract class BaseActividad extends BaseObject  implements Persistent
{
	...
	public function setFechaHora($v)
	{
		...
		if ( $this->fecha_hora !== null || $dt !== null ) {
			...
			$currNorm = ($this->fecha_hora !== null && $tmpDt = new DateTime($this->fecha_hora)) ? $tmpDt->format('Y-m-d\\TH:i:sO') : null;
			$newNorm = ($dt !== null) ? $dt->format('Y-m-d\\TH:i:sO') : null;

			if ( ($currNorm !== $newNorm) // normalized values don't match 
					)
			{
				$this->fecha_hora = ($dt ? $dt->format('Y-m-d\\TH:i:sO') : null);
				$this->modifiedColumns[] = ActividadPeer::FECHA_HORA;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->fecha_hora = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->resetModified();
			...
			return $startcol + 16; // 16 = ActividadPeer::NUM_COLUMNS - ActividadPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[15], $arr)) $this->setFechaHora($arr[$keys[15]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ActividadPeer::FECHA_HORA)) $criteria->add(ActividadPeer::FECHA_HORA, $this->fecha_hora);
