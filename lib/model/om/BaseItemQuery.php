 ...
 *
 * @method     ItemQuery leftJoinRespuestaEncuestaExpositor($relationAlias = null) Adds a LEFT JOIN clause to the query using the RespuestaEncuestaExpositor relation
 * @method     ItemQuery rightJoinRespuestaEncuestaExpositor($relationAlias = null) Adds a RIGHT JOIN clause to the query using the RespuestaEncuestaExpositor relation
 * @method     ItemQuery innerJoinRespuestaEncuestaExpositor($relationAlias = null) Adds a INNER JOIN clause to the query using the RespuestaEncuestaExpositor relation
 *
 * @method     ItemQuery leftJoinRespuestaEncuestaVisitante($relationAlias = null) Adds a LEFT JOIN clause to the query using the RespuestaEncuestaVisitante relation
 * @method     ItemQuery rightJoinRespuestaEncuestaVisitante($relationAlias = null) Adds a RIGHT JOIN clause to the query using the RespuestaEncuestaVisitante relation
 * @method     ItemQuery innerJoinRespuestaEncuestaVisitante($relationAlias = null) Adds a INNER JOIN clause to the query using the RespuestaEncuestaVisitante relation
 *
...
abstract class BaseItemQuery extends ModelCriteria
{
	...
	/**
	 * Filter the query by a related RespuestaEncuestaExpositor object
	 *
	 * @param     RespuestaEncuestaExpositor $respuestaEncuestaExpositor  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ItemQuery The current query, for fluid interface
	 */
	public function filterByRespuestaEncuestaExpositor($respuestaEncuestaExpositor, $comparison = null)
	{
		return $this
			->addUsingAlias(ItemPeer::ID, $respuestaEncuestaExpositor->getIdItem(), $comparison);
	}

	/**
	 * Adds a JOIN clause to the query using the RespuestaEncuestaExpositor relation
	 * 
	 * @param     string $relationAlias optional alias for the relation
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    ItemQuery The current query, for fluid interface
	 */
	public function joinRespuestaEncuestaExpositor($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
	{
		$tableMap = $this->getTableMap();
		$relationMap = $tableMap->getRelation('RespuestaEncuestaExpositor');
		...
		if($relationAlias) {
			...
			$this->addJoinObject($join, 'RespuestaEncuestaExpositor');
		}
	...
	/**
	 * Use the RespuestaEncuestaExpositor relation RespuestaEncuestaExpositor object
	 *
	 * @see       useQuery()
	 * 
	 * @param     string $relationAlias optional alias for the relation,
	 ...
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    RespuestaEncuestaExpositorQuery A secondary query class using the current class as primary query
	 */
	public function useRespuestaEncuestaExpositorQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
	{
		return $this
			->joinRespuestaEncuestaExpositor($relationAlias, $joinType)
			->useQuery($relationAlias ? $relationAlias : 'RespuestaEncuestaExpositor', 'RespuestaEncuestaExpositorQuery');
	}

	/**
	 * Filter the query by a related RespuestaEncuestaVisitante object
	 *
	 * @param     RespuestaEncuestaVisitante $respuestaEncuestaVisitante  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ItemQuery The current query, for fluid interface
	 */
	public function filterByRespuestaEncuestaVisitante($respuestaEncuestaVisitante, $comparison = null)
	{
		return $this
			->addUsingAlias(ItemPeer::ID, $respuestaEncuestaVisitante->getIdItem(), $comparison);
	}

	/**
	 * Adds a JOIN clause to the query using the RespuestaEncuestaVisitante relation
	 * 
	 * @param     string $relationAlias optional alias for the relation
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    ItemQuery The current query, for fluid interface
	 */
	public function joinRespuestaEncuestaVisitante($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
	{
		$tableMap = $this->getTableMap();
		$relationMap = $tableMap->getRelation('RespuestaEncuestaVisitante');
		...
		if($relationAlias) {
			...
			$this->addJoinObject($join, 'RespuestaEncuestaVisitante');
		}
	...
	/**
	 * Use the RespuestaEncuestaVisitante relation RespuestaEncuestaVisitante object
	 *
	 * @see       useQuery()
	 * 
	 * @param     string $relationAlias optional alias for the relation,
	 ...
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    RespuestaEncuestaVisitanteQuery A secondary query class using the current class as primary query
	 */
	public function useRespuestaEncuestaVisitanteQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
	{
		return $this
			->joinRespuestaEncuestaVisitante($relationAlias, $joinType)
			->useQuery($relationAlias ? $relationAlias : 'RespuestaEncuestaVisitante', 'RespuestaEncuestaVisitanteQuery');
	}
