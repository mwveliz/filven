 ...
 * @method     VisitanteQuery orderByIdSala($order = Criteria::ASC) Order by the id_sala column
 ...
 * @method     VisitanteQuery groupByIdSala() Group by the id_sala column
 ...
 *
 * @method     VisitanteQuery leftJoinSala($relationAlias = null) Adds a LEFT JOIN clause to the query using the Sala relation
 * @method     VisitanteQuery rightJoinSala($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Sala relation
 * @method     VisitanteQuery innerJoinSala($relationAlias = null) Adds a INNER JOIN clause to the query using the Sala relation
 *
 ...
 * @method     Visitante findOneByIdSala(string $id_sala) Return the first Visitante filtered by the id_sala column
 ...
 * @method     array findByIdSala(string $id_sala) Return Visitante objects filtered by the id_sala column
...
abstract class BaseVisitanteQuery extends ModelCriteria
{
	 ...
	 * 
	 * @param     string|array $idSala The value to use as filter.
	 *            Accepts an associative array('min' => $minValue, 'max' => $maxValue)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    VisitanteQuery The current query, for fluid interface
	...
	public function filterByIdSala($idSala = null, $comparison = null)
	{
		if (is_array($idSala)) {
			$useMinMax = false;
			if (isset($idSala['min'])) {
				$this->addUsingAlias(VisitantePeer::ID_SALA, $idSala['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($idSala['max'])) {
				$this->addUsingAlias(VisitantePeer::ID_SALA, $idSala['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(VisitantePeer::ID_SALA, $idSala, $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(VisitantePeer::ID_SALA, $sala->getId(), $comparison);
	}
